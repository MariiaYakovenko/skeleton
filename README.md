...
$ docker run --rm -p 8080:3000 --env-file .env skeleton-api
```

## API testing (Postman)

- Collection: [`postman/api-collection.json`](./postman/api-collection.json)
- Environment: [`postman/docker.postman_environment.json`](./postman/docker.postman_environment.json)
